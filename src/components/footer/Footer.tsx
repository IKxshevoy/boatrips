    ...
    <section className={styles.contact}>
      <footer className={styles.footer}>
        <div className={styles.main}>
          {
            footerBlocks.map(item => Object.entries(item).map(([title, linkItems], index) =>
          ...
          <ListWrapper title="Certificates">
            <div className={styles.certificates}>
              <Image src="/certificates/certificate1.png" alt="certificate1" width={120} height={120} />
              <Image src="/certificates/certificate2.png" alt="certificate2" width={120} height={120} />
            </div>
          </ListWrapper>
        </div>
      </footer>
